...
uint MyRigidBody::SAT(MyRigidBody* const a_pOther)
{
	...
	// I had to change the key inputs for moving the creeper from the arrow keys
	// My keyboard does not have arrow keys.
	// I believe I changed them back but I have no way to test if it is working with arrow key inputs
	// but i did test it with IJKL inputs
	...
	// brought into a's coordinate frame
