...
bool Octant::IsColliding(uint a_uRBIndex)
{
	...
	if (m_v3Min.x > v3MaxCurrent.x)
	{
		return false;
	}
	if (m_v3Max.x < v3MinCurrent.x)
	{
		return false;
	}

	// Test ARBB for y coordinates
	if (m_v3Min.y > v3MaxCurrent.y)
	{
		return false;
	}
	if (m_v3Max.y < v3MinCurrent.y)
	{
		return false;
	}

	// Test ARBB for z coordinates
	if (m_v3Min.z > v3MaxCurrent.z)
	{
		return false;
	}
	if (m_v3Max.z < v3MinCurrent.z)
	{
		return false;
	}
